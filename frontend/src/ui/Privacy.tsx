...
export function Privacy() {
  ...
  return (
    <div className="admin">
      ...
      <p>
        「コエコミ」（以下「本アプリ」）は、小学生向けイベントでの体験を目的とした Web
        アプリケーションです。本アプリにおける個人情報および音声データの取り扱いについて、
        以下のとおり定めます。
      </p>
      ...
      <div className="card">
        ...
        <ul>
          ...
          <li>
            音声データを
            <strong>第三者（外部のクラウドサービス等）へ送信することはありません</strong>。
          </li>
          <li>
            録音音声および生成した音声は一時的に保存され、<strong>イベント終了後に削除</strong>
            します。
          </li>
